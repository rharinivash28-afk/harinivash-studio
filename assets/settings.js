...
(function(){
  ...
  function applyColor(id){
    ...
    var mesh =
      'radial-gradient(60% 50% at 12% 8%, '+rgba(c.acc,0.20)+' 0%, transparent 60%),'+
      'radial-gradient(55% 45% at 88% 18%, '+rgba(c.vio,0.16)+' 0%, transparent 62%),'+
      'radial-gradient(50% 50% at 78% 92%, '+rgba(c.acc,0.13)+' 0%, transparent 60%),'+
      'radial-gradient(45% 45% at 22% 88%, '+rgba(c.hi,0.10)+' 0%, transparent 62%)';
